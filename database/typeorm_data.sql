...
INSERT INTO `typeorm`.`user` (`username`, `email`, `password`, `role`) VALUES
...
INSERT INTO `typeorm`.`post` (`title`,`text`,`type`,`date`, `userId`) VALUES
...
INSERT INTO `typeorm`.`tag` (`tag`) VALUES
('AOR'),
('MIKS'),
('GRAFIKA'),
...
INSERT INTO `typeorm`.`post_tag` (`postId`,`tagId`) VALUES
(1, 1),
(8, 1),
(1, 2),
(5, 2),
...
INSERT INTO `typeorm`.`post_file` (`path`, `ext`, `postId`) VALUES
...
INSERT INTO `typeorm`.`postLikedBy` (`postId`, `userId`) VALUES
(1, 1),
(1, 2),
(1, 3),
(2, 1),
...
INSERT INTO `typeorm`.`postDislikedBy` (`postId`, `userId`) VALUES
(2, 3),
(3, 3),
(4, 3);

INSERT INTO `typeorm`.`comment` (`text`, `date`, `userId`, `postId`) VALUES
...
INSERT INTO `typeorm`.`commentLikedBy` (`commentId`, `userId`) VALUES
(1, 1),
(1, 3),
(2, 1),
(3, 1),
...
INSERT INTO `typeorm`.`commentDislikedBy` (`commentId`, `userId`) VALUES
(1, 2);

INSERT INTO `typeorm`.`comment_file` (`path`, `ext`, `commentId`) VALUES
